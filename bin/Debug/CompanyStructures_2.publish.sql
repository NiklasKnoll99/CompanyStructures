...
GO
ALTER TABLE [dbo].[Employee] DROP CONSTRAINT [FK__Employee__Employ__4D94879B];
...
GO
ALTER TABLE [dbo].[Employee] ALTER COLUMN [EmploymentTimeId] INT NULL;

ALTER TABLE [dbo].[Employee] ALTER COLUMN [Pay] MONEY NULL;
