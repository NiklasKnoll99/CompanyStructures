...
GO
ALTER TABLE [dbo].[City] DROP CONSTRAINT [DF__tmp_ms_xx__Creat__778AC167];
...
GO
ALTER TABLE [dbo].[Address] DROP CONSTRAINT [FK__Address__CityId__7E37BEF6];
...
GO
ALTER TABLE [dbo].[City] DROP CONSTRAINT [FK__City__ProvinceId__7F2BE32F];
...
GO
ALTER TABLE [dbo].[Address] ALTER COLUMN [CityId] NVARCHAR (16) NOT NULL;
...
GO
ALTER TABLE [dbo].[Company] ALTER COLUMN [CompanyName] NVARCHAR (128) NOT NULL;


GO
PRINT N'[dbo].[Department2Address] wird erstellt....';
...
GO
ALTER TABLE [dbo].[Department2Address]
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Address'), OBJECT_ID(N'dbo.City'), OBJECT_ID(N'dbo.Department2Address'))
               AND [type] IN (N'F', N'C')
