...
AS
	BEGIN
		IF (((SELECT Company.Id FROM Company WHERE Company.Id = @id) IS NULL) AND (SELECT Company.CompanyName FROM Company WHERE Company.CompanyName = @companyName) IS NULL)
		BEGIN
