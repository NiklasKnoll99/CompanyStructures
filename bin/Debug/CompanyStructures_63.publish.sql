...
GO
ALTER TABLE [dbo].[Address] DROP CONSTRAINT [FK__Address__CityId__1DB06A4F];
...
GO
ALTER TABLE [dbo].[City] DROP CONSTRAINT [FK__City__ProvinceId__1EA48E88];
...
GO
ALTER TABLE [dbo].[City] ALTER COLUMN [ProvinceId] INT NULL;
...
GO
ALTER TABLE [dbo].[EmploymentTime] ALTER COLUMN [EmploymentEnd] DATETIME2 (7) NULL;

ALTER TABLE [dbo].[EmploymentTime] ALTER COLUMN [EmploymentStart] DATETIME2 (7) NOT NULL;
